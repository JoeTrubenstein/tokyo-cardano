...
const CnftFeed = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://api.opencnft.io/1/rank`)
        ...
        <div className="flex flex-wrap -m-4">
          {cnftList ? (
            cnftList.slice(0, 6).map(cnft => (
              <div key={cnft.name} className="p-4 md:w-1/3">
                <div className="h-full border-2  border-bubble-gum border-opacity-60 rounded-lg overflow-hidden">
                  {cnft.thumbnail_type == "video/mp4" ? (
                    <video
                      ...
                      loop
                      muted
                      className="lg:h-48 md:h-36 w-full h-56 object-cover object-center"
                    >
                      <source
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center flex-wrap ">
                      <a href={cnft.link} className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
                        Learn More
                        <svg
