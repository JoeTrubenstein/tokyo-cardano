...
<section className="dark:bg-nightBack">
  <div className=" dark:bg-nightBack px-4 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
    <div className="flex flex-wrap items-center mx-auto max-w-7xl">
      ...
      <div className="flex flex-col items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
        <span className="mb-8 text-xs font-bold tracking-widest text-blue-600 uppercase"> {post.frontmatter.date}</span>
        <h1 className="mb-8 text-4xl font-bold leading-none tracking-tighter text-neutral-600 md:text-7xl lg:text-5xl">{post.frontmatter.title}</h1>
        <p className="mb-8 text-base leading-relaxed text-left text-gray-500">{post.frontmatter.excerpt}</p>
...
<div className="px-4 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 prose dark:text-white dark:prose-headings:text-white dark:bg-nightBack dark:prose-a:text-nightBlue" dangerouslySetInnerHTML={{ __html: post.html }}/>
